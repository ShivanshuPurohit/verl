...
class DataProto:
    ...
    @classmethod
    def from_tensordict(cls, tensordict: TensorDict, meta_info=None):
        """Create a DataProto from a TensorDict object.
        
        Args:
            tensordict (TensorDict): The TensorDict to convert to DataProto
            meta_info (Dict, optional): Meta information to include. Defaults to None.
            
        Returns:
            DataProto: A new DataProto object containing the TensorDict data
        """
        if meta_info is None:
            meta_info = {}
            
        return cls(batch=tensordict, non_tensor_batch={}, meta_info=meta_info)
